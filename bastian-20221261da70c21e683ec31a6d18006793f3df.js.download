...
p("feedId",e.id||Object(a.get)(e,"items.0.feedId")||"unknown-feedId"),p("referer",e.referer),p("recommendationCounter",0),y(e),O(e),S(e),w(e),_(e),E(e)},E=e=>{const t=Object(c.getHeadlinesType)(e)
...
e[n]=i}),e.parameters=void 0},_=(e={})=>Object(i.get)(e,"content.video.id"),y=e=>{const{hasCustomHeadlines:t}=m(e)
let n
if(t)return n
if(f(e))n=v(e)[0].imgUrl
else{const t=O(e)
t&&(n=((e={})=>"video"===e.type)(t)&&_(t)?Object(r.buildUrlForPostVideo4x3)(_(t)):Object(r.choosePicture)(t.content.image))}return n},O=e=>{const{items:t=[]}=e
let n
...
return Object(g.get)(s,o+".url")||i()(s)[0].url}if(d()(e.url))return e.url}const w=e=>"https://s03.video.glbimg.com/480x360/"+e+".jpg"},function(e,t,n){var r=n(31),i=n(33)
...
if(null!=a&&(void 0===c?a==a&&!r(a):n(a,c)))var c=a,l=o}return l}},function(e,t){e.exports=function(){return!1}},function(e,t){e.exports=function(e,t){return e<t}},function(e,t){e.exports=function(e){return e}},function(e,t,n){var r=n(41)
...
return n.cache=new(i.Cache||r),n}i.Cache=r,e.exports=i},function(e,t,n){var r=n(42),i=n(43),s=n(46),o=n(47),a=n(48)
...
const _=p,y=f,O="seems to be missing on the page",w=i()(e=>Object(d.warn)(e,O))},function(e,t,n){var r=n(62),i=n(63)((function(e,t){return r(e,1,t)}))
e.exports=i},function(e,t){e.exports=function(e,t,n){if("function"!=typeof e)throw new TypeError("Expected a function")
return setTimeout((function(){e.apply(void 0,n)}),t)}},function(e,t,n){var r=n(39),i=n(64),s=n(66)
...
n.r(t),n.d(t,"render",(function(){return D})),n.d(t,"hydrate",(function(){return M})),n.d(t,"createElement",(function(){return g})),n.d(t,"h",(function(){return g})),n.d(t,"Fragment",(function(){return E})),n.d(t,"createRef",(function(){return b})),n.d(t,"isValidElement",(function(){return i})),n.d(t,"Component",(function(){return _})),n.d(t,"cloneElement",(function(){return H})),n.d(t,"createContext",(function(){return V})),n.d(t,"toChildArray",(function(){return C})),n.d(t,"_unmount",(function(){return k})),n.d(t,"options",(function(){return r}))
...
e.exports=function(e){return r(e)&&1===e.nodeType&&!i(e)}},function(e,t,n){var r=n(2),i=n(109),s=n(4),o=Function.prototype,a=Object.prototype,c=o.toString,l=a.hasOwnProperty,u=c.call(Object)
e.exports=function(e){if(!s(e)||"[object Object]"!=r(e))return!1
var t=i(e)
if(null===t)return!0
var n=l.call(t,"constructor")&&t.constructor
return"function"==typeof n&&n instanceof n&&c.call(n)==u}},function(e,t,n){var r=n(34)(Object.getPrototypeOf,Object)
...
z&&K?G[G.length-1]+=$:G.push($),z=K}else G.push($)}}if(_&&B)for(var Z=G.length;Z--;)G[Z]="\n"+y+o(G[Z],y)}if(G.length)P+=G.join("")
...
const E=h},function(e,t,n){var r=n(117),i=n(6)
e.exports=function(e,t,n){var s=!0,o=!0
if("function"!=typeof e)throw new TypeError("Expected a function")
return i(n)&&(s="leading"in n?!!n.leading:s,o="trailing"in n?!!n.trailing:o),r(e,t,{leading:s,maxWait:t,trailing:o})}},function(e,t,n){var r=n(6),i=n(118),s=n(53),o=Math.max,a=Math.min
...
if(g)return clearTimeout(d),d=setTimeout(y,t),b(p)}return void 0===d&&(d=setTimeout(y,t)),h}return t=s(t)||0,r(n)&&(m=!!n.leading,u=(g="maxWait"in n)?o(s(n.maxWait)||0,t):u,v="trailing"in n?!!n.trailing:v),w.cancel=function(){void 0!==d&&clearTimeout(d),f=0,c=p=l=d=void 0},w.flush=function(){return void 0===d?h:O(i())},w}},function(e,t,n){var r=n(97)
...
let r
n.r(t),n.d(t,"rAF",(function(){return i})),r=n(54).Globals.requestAnimationFrame
...
const o=({text:e})=>r.Engine.createElement(i.LabelEvent,{type:"click",label:"resumo"},r.Engine.createElement("div",{className:"feed-post-body-resumo",elementtiming:"text-"+s.Configs.get("renderContext")},e))},function(e,t,n){"use strict"
...
if(!i)for(r=[].concat(this.children.slice(0,e),this.children.slice(t,this.children.length)),n=0;n<r.length;n+=1)r[n].verifyVisibility()&&(this.pointer=this.children.indexOf(r[n]))}registerChild(e){this.children.push(e)}unregisterChild(e){Object(u.pull)(this.children,e)}componentDidMount(){this.context.parentTrigger.on("visible",this.handleParentVisibility)}componentWillUnmount(){this.context.parentTrigger.off("visible",this.handleParentVisibility)}},r.displayName="evg",h=i
const d=h},function(e,t,n){"use strict"
...
return-1}clear(){this.items.splice(0,this.items.length)}static destroy(){i.forEach(e=>e.clear()),i.splice(0,i.length)}}o.HEADLINE_PLACEHOLDER="headline_placeholder"},function(e,t,n){var r=n(171),i=n(172),s=n(173),o=n(3),a=n(174),c=n(176),l=n(177),u=n(178),h=Object.prototype.hasOwnProperty
e.exports=function(e){if(null==e)return!0
...
var r=n(54),i=n(195)
const s=()=>(r.Globals.postVideoPreviewAB||{}).alternative,o=()=>Object(i.hasVideoPreviewSupport)("preview-all"===s()),a=()=>!("control"===s())&&o()},function(e,t,n){e.exports="12.7.1",e.exports.default=e.exports},function(e,t,n){"use strict"
n.r(t)
...
const u=l,h=e=>t=>o.Engine.createElement("h2",null,o.Engine.createElement("a",{href:e.url,className:"feed-post-link gui-color-primary gui-color-hover",elementtiming:e.elementtiming},t.children))
var d=n(129),p=n(134),f=n(100),m=n(56),g=n(124),v=n.n(g),b=n(194),E=n(123),_=n(136),y=n(170),O=n.n(y),w=e=>!e||O()(e),S=n(125),I=n(135),C=n(137),x=n(138)
const T=e=>{const{extraClasses:t,isEsppub:n,video:r,image:i,url:a,title:c,children:l,onReveal:u,onMouseUp:h,threshold:d,ratio:p="1:1"}=e,f="bstn-fd-video-cover "+(t||"")
let m
...
var A=n(29),j=n(55),N=n(115),R=n(180)
...
const M=({children:e,isLive:t,video:n})=>o.Engine.createElement("div",{className:"feed-cover-content"},e,o.Engine.createElement("div",{className:"bstn-fd-play-button"},D,((e,t)=>e?L:Object(S.insertIf)(t>0,()=>o.Engine.createElement("p",{className:"feed-post-video-duration"},Object(I.abbrTime)(t))))(t,n.duration)),Object(S.insertIf)(n.trademark,()=>o.Engine.createElement("img",{className:"feed-post-video-trademark",src:n.trademark,loading:"lazy"}))),H=e=>{const{image:t,video:n,canShowVideoPreview:r,disableLightbox:i}=e
let s
...
var V=n(23)
const F=({image:e,video:t})=>w(e)?null:Boolean(t)&&Boolean(t.id)&&!V.Configs.get("photoOverVideo")?"video":"photo",U={video:({image:e,video:t,title:n,url:r,isEsppub:i,canShowVideoPreview:s})=>o.Engine.createElement(H,{title:n,url:r,video:t,image:e,isEsppub:i,canShowVideoPreview:s}),photo:({image:e,isEsppub:t})=>{const n=e.rightsHolder?"Foto: ("+e.rightsHolder+")":null
return o.Engine.createElement(s.Cover,{images:e,alt:n,isEsppub:t})}},G=e=>{const{image:t,video:n,url:r}=e,i=F({image:t,video:n})
return null===i?null:o.Engine.createElement("div",{className:"feed-media-wrapper"},o.Engine.createElement(a.LabelEvent,{type:"click",label:"midia"},o.Engine.createElement("a",{href:r,className:"feed-post-figure-link gui-image-hover"},U[i](e))))}
var B=n(127)
const z=e=>{const{date:t,section:n}=e
return o.Engine.createElement("div",{className:"feed-post-metadata"},Object(S.insertIf)(!1===V.Configs.get("disableDateTime"),()=>o.Engine.createElement(b.Datetime,{isRecommended:t.isRecommended,ageInSeconds:t.age,publication:t.publication})),n&&o.Engine.createElement(B.Section,{text:n}))}
var q=n(126),W=n(128),$=n(54),K=n(182)
const Z="postVideoFull",Y="postVideoRedirectAB",J=e=>$.Globals[e],X=({contentType:e})=>"video"===e
let Q,ee,te
Q=({tenantId:e})=>e===m.Settings.get("PORTAL"),ee=({content:e,tenantId:t})=>{const n=[$.Globals.location.hostname],r=new URL(e.url)
return"ge"===t&&(n.push("globoesporte.globo.com"),n.push("ge.globo.com"),n.push("globoesporte.qa.globoi.com"),n.push("ge.qa.globoi.com")),r&&n.includes(r.hostname)},te=({content:e})=>e.url===$.Globals.location.href
const ne=e=>Boolean(J(Y))&&X(e)&&Q(e)&&ee(e)&&!te(e),re=e=>{if(!Object(K.hasExperimentFeatVideoPreviewSupport)())return!1
const{content:t,media:n,contentType:r}=e
if(!["basico","materia","materia_video"].includes(r))return!1
const i=(t.video||{}).previewUrl
return"video"===n&&Boolean(i)},ie=e=>{const t=(J(Y)||{}).alternative
return ne(e)&&"pagevideo"===t},se=[{name:"postVideoPreviewAB",isAvailableForPost:re,impressionOnPostView:!0,conversionOnPostClick:!0},{name:Z,isAvailableForPost:e=>Boolean(J(Z))&&X(e),impressionOnPostView:!0,conversionOnPostClick:!0},{name:Y,isAvailableForPost:ne,impressionOnPostView:!0,conversionOnPostClick:!0}]
var oe=n(144),ae=n(90),ce=n(85),le=n(57)
class ue extends o.Engine.Component{constructor(e){super(e),this.getPostContentData=()=>{const e=Object(c.get)(this,"props.content")
return{content:e,media:F(e),contentType:this.getContentType(),tenantId:Object(c.get)(this,"props.tenantId")}},this.state={title:this.isMabEnabled()?"":Object(c.get)(e,"content.title"),renderContext:V.Configs.get("renderContext")}}render(){const e=v()("feed-post","bstn-item-shape",{["type-"+this.props.type]:this.props.type})
return o.Engine.createElement("div",{ref:Object(f.as)(this,"post"),className:e,id:this.props.id},o.Engine.createElement("div",{className:"feed-post-body"},this.Header(),this.Title(),this.Summary(),this.Media(),this.Metadata(),this.Relateds()))}componentWillMount(){this.reporter=ae.ItemPostReporter.upgrade(this.context.sharedItemData),this.reporter.addFeatureChecks({resumo:()=>this.hasSummary(),foto:()=>"photo"===F(Object(c.get)(this,"props.content")),video:()=>"video"===F(Object(c.get)(this,"props.content"))})}componentDidMount(){this.isMabEnabled()&&this.installMab()}componentWillUnmount(){this.uninstallMab()}isMabEnabled(){if(j.At.server)return!1
const e=Object(c.get)(this,"props.content.mab.experiment")
return e&&Object(oe.isMabAvailiable)(e)}async installMab(){const e=Object(c.get)(this,"props.content.mab.experiment")
if(e)try{const t=await Object(oe.requestMabExperiment)({experimentName:e}),n=this.props.content.mab.metadata[t.arm]
...
return o.Engine.createElement(G,{ref:Object(f.as)(this,F(Object(c.get)(this,"props.content"))),title:e,url:t,video:n,image:r,isEsppub:Object(le.has)(this,"props.pubeditorial"),postContentType:this.getContentType(),canShowVideoPreview:(i=this.getPostContentData(),Object(K.isExperimentFeatVideoPreviewEnabled)()&&re(i))})
var i}Metadata(){let e
const t=m.Settings.get("PORTAL")
return["valor","valor-investe"].indexOf(t)>=0&&(e=this.props.publication),o.Engine.createElement(z,{section:this.props.content.section,date:{age:this.props.age,publication:e,isRecommended:this.props.isRecommended}})}Header(e){return o.Engine.createElement(E.Header,{content:this.props.content,parent:this},e)}Title(){return Object(le.has)(this,"state.title")?o.Engine.createElement(d.Title,{text:this.state.title,innerWrapper:h({url:this.getUrl(),elementtiming:"text-"+this.state.renderContext})}):null}hasSummary(){const e=this.props.aggregatedPosts
...
e=this.getPostContentData(),se.forEach(t=>{const n=J(t.name)
n&&n.impression&&t.impressionOnPostView&&t.isAvailableForPost(e)&&n.impression()})}onClick(){var e
this.clicked||(e=this.getPostContentData(),se.forEach(t=>{const n=J(t.name)
...
for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e}).apply(this,arguments)}ue.FACE="basico",ue.SIZE=ce.POST_SIZES.MEDIUM
class de extends ue{constructor(...e){super(...e),this.Header=()=>String(m.Settings.get("PORTAL")).startsWith("valor")?null:o.Engine.createElement(u,{pubeditorial:this.props.pubeditorial})}getContentType(){return"especial-publicitario"}Title(){return o.Engine.createElement(d.Title,{text:this.state.title||this.props.content.title,extraClasses:"feed-post-advertising-title",innerWrapper:h({url:this.getUrl()})})}renderVideo(){return Object(c.get)(this,"props.content.video.id")?o.Engine.createElement(p.Video,he({ref:Object(f.as)(this,"video")},this.props.content,{isEsppub:!0})):null}renderImage(){const e=this.props.content.image
if(e){let t=Object(c.get)(this,"props.content.image.rightsHolder")||null
return t&&(t="Foto: ("+t+")"),o.Engine.createElement(s.Cover,{ref:Object(f.as)(this,"photo"),images:e,alt:t,isEsppub:!0})}return null}}de.FACE="especial_publicitario"
var pe=n(75),fe=n(5),me=n.n(fe),ge=n(61),ve=n.n(ge),be=n(106),Ee=n(191),_e=n(117),ye=n.n(_e),Oe=n(131)
let we
we=class extends(Object(Oe.drawless)(o.Engine.Component)){constructor(e){super(e),this.observe=()=>{this.observer&&(this.observer.observe(this._refs.node,{childList:!0,subtree:!0,attributes:!0,attributesFilter:["style","width","height"]}),this.checkMutation())},this.checkMutation=ye()(()=>{const{offsetHeight:e,offsetWidth:t}=this._refs.node,n=e>=this.minHeight&&t>=this.minWidth
if(n!==this.isBoxed&&(this.isBoxed=n,me()(this.props.onChange)))try{this.props.onChange(n,{height:e,width:t})}catch(i){Object(r.error)(i)}this.disconnectObserver()},500,{leading:!0,trailing:!0}),this.disconnectObserver=ye()(()=>{this.observer&&(this.observer.disconnect(),this.observer=null)},1e4,{leading:!1,trailing:!0}),this.isBoxed=!1,this.minHeight=this.props.minHeight||1,this.minWidth=this.props.minWidth||1,this.observer=new MutationObserver(this.checkMutation)}componentDidMount(){me()(this.props.manualStart)?this.props.manualStart(this.observe):this.observe()}}
const Se=we
function Ie(){return(Ie=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]
for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e}).apply(this,arguments)}const Ce=Ie({},be,{ui:Ie({},Ee)}),xe=e=>{var t,n
return n=t=class extends o.Engine.Component{constructor(...e){super(...e),this.state={imploded:!1},this.syncBoxingState=e=>{this.isBoxed=e}}render(){return o.Engine.createElement(Se,{onChange:this.syncBoxingState,minHeight:3},Object(S.insertIf)(!this.state.imploded,()=>o.Engine.createElement("div",{className:"post-item"},o.Engine.createElement("div",{ref:Object(f.as)(this),className:"bstn-item-shape"}))))}componentWillMount(){ae.ItemPostReporter.upgrade(this.context.sharedItemData)}componentDidMount(){ve()(()=>{const t=this.context,n=Ie({},Ce)
be.patch(n,{areaId:t.areaId,item:t.item,itemIndex:t.itemIndex,source:this.props.source,implode:this.implode.bind(this)})
try{me()(e)&&e(this.props,this._refs.node,n)}catch(i){Object(r.error)("[component] ["+this.props.type+"]\n",i)}})}shouldComponentUpdate(e,t){return t.imploded}implode(){this.setState({imploded:!0})
const{props:e}=this
Object(r.warn)("The item of type "+e.type+" self imploded.",e)}},t.FACE="component",t.SIZE=ce.POST_SIZES.MEDIUM,n}
class Te extends ae.ItemPostReporter{get contentStatus(){if(this.itemProps.isLive)return"ao_vivo"}}var Ae=o.Engine.createElement(C.BadgeAoVivo,null)
class je extends ue{constructor(...e){super(...e),this.isLive=()=>Object(c.get)(this.props,"cobertura.isLive"),this.Header=()=>{const{content:e}=this.props
return this.isLive()?o.Engine.createElement(E.Header,{content:e},Ae):o.Engine.createElement(E.Header,{content:e})}}componentWillMount(){this.reporter=Te.upgrade(this.context.sharedItemData,{isLive:this.isLive()})}}je.FACE="cobertura"
var Ne=n(112),Re=n.n(Ne),Pe=n(197),ke=n(143)
function Le(){return(Le=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]
for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e}).apply(this,arguments)}const De={criado:1,iniciado:2,INITIATED:2,"em andamento":3,IN_PROGRESS:3,encerrado:4,CLOSED:4}
var Me=o.Engine.createElement("div",{className:"bstn-aovivo-label"},"tempo real")
class He extends ue{constructor(e){super(e),this.state.match=e.match}render(){return o.Engine.createElement("div",{ref:Object(f.as)(this,"post"),className:"feed-post bstn-item-shape bstn-face-temporeal type-"+this.props.type},o.Engine.createElement("div",{className:"feed-post-body"},this.Header(),this.Score(),this.Title(),this.Summary(),this.Media(),this.Metadata(),this.Relateds()))}componentWillMount(){this.reporter=Ve.upgrade(this.context.sharedItemData,{status:this.getStatus()}),this.reporter.addFeatureChecks({placar:()=>this.hasScore(),label_tr:()=>this.hasLabelTempoReal(),destaques:()=>this.hasHighlights(),resumo:()=>this.hasSummary(),espectadores:()=>this.showSpectators()})}componentDidMount(){this.completeRecommended()}async completeRecommended(){const{match:e,isRecommended:t}=this.props
if(e&&e.resume&&t){const t=await fetch(e.resume),n=await t.json()
this.fillRecommended(n)}}fillRecommended(e){const t=Le({},this.state.match)
t&&(t.homeTeam.score=e.equipe_mandante.placar||0,t.awayTeam.score=e.equipe_visitante.placar||0,t.homeTeam.penalties=e.equipe_mandante.penalti||0,t.awayTeam.penalties=e.equipe_visitante.penalti||0,t.status=e.status,this.setState({match:t}))}Header(){return super.Header(this.hasLabelTempoReal()?Me:null)}Metadata(){let e=null
return this.showSpectators()&&(e=o.Engine.createElement("span",{className:"post-tr-spectators"},this.props.match.spectators.toLocaleString("pt-br")," assistindo")),o.Engine.createElement("div",{className:"feed-post-metadata"},o.Engine.createElement(b.Datetime,{isRecommended:this.props.isRecommended,ageInSeconds:this.props.age}),e)}Summary(){return this.hasHighlights()?o.Engine.createElement(Pe.Highlight,{content:this.state.match.highlights[0]}):this.hasSummary()?super.Summary():null}Score(){if(this.hasScore()){const{awayTeam:e,homeTeam:t}=this.state.match
return o.Engine.createElement(ke.Scoreboard,{away:e,home:t})}return null}isLive(){const e=((this.props.match||{}).status||"").toLowerCase()
return!!Re()(De[e],De.INITIATED,De.CLOSED)&&(!!this.props.isRecommended||0===String(this.props.content.summary||"").trim().length)}hasScore(){return Boolean(this.state.match)}hasLabelTempoReal(){return this.isLive()}hasChapeu(){return!this.hasLabelTempoReal()&&Object(c.get)(this.props.content,"chapeu.label")}hasSummary(){return!this.hasHighlights()&&super.hasSummary()}hasHighlights(){return this.isLive()&&Object(c.get)(this.state,"match.highlights",[]).length>0}showSpectators(){return this.hasLabelTempoReal()&&Object(c.get)(this.props,"content.showSpectators")&&this.state.match.spectators>0}getStatus(){return(Object(c.get)(this.props,"match.status")||"encerrada").toLowerCase()}}He.FACE="tempo_real"
class Ve extends ae.ItemPostReporter{get contentStatus(){if(this.itemProps.status)return this.itemProps.status}}var Fe=n(146),Ue=n(147),Ge=n.n(Ue),Be=n(168)
function ze(){return(ze=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]
for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e}).apply(this,arguments)}const qe=e=>{const{extraClasses:t,image:n,description:r,thumbOrientation:i,url:a,title:c,children:l,ratio:u="1:1"}=e,h="bstn-fd-stories-cover "+(t||"")
let d
...
var We=o.Engine.createElement(Be.default,{device:"mobile"})
const $e=e=>{return o.Engine.createElement(qe,ze({},e,{thumbOrientation:"V"}),o.Engine.createElement("div",{className:"stories__content"},o.Engine.createElement("div",{className:"stories__content--header"}," ",Ge()(e,"chapeu.label",e.section)," "),o.Engine.createElement("div",null,We,o.Engine.createElement("p",{className:"stories__content--title"}," ",(t=e.title,n=70,t.length>n?t.substring(0,n)+"...":t)," "),o.Engine.createElement("div",{className:"stories__content--metadata"},e.children))))
var t,n}
var Ke=o.Engine.createElement("div",{className:"bstn-fd-play-button"},o.Engine.createElement(Be.default,{device:"desktop"}))
const Ze=e=>o.Engine.createElement(qe,ze({},e,{thumbOrientation:"H"}),Ke),Ye=e=>e.desktop?o.Engine.createElement(Ze,e):o.Engine.createElement($e,e)
function Je(){return(Je=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]
for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e}).apply(this,arguments)}var Xe=n(161)
function Qe(){return(Qe=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]
for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e}).apply(this,arguments)}function et(){const e=V.Configs.get("recommendationTag",null)
e&&me()($.Globals.convertRecAb)&&$.Globals.convertRecAb(e)}var tt=o.Engine.createElement(C.BadgeAoVivo,null)
class nt extends ue{constructor(...e){super(...e),this.renderHeader=()=>o.Engine.createElement("div",{className:"feed-post-video-full-header"},Object(c.get)(this.props,"content.chapeu.label")),this.renderTitle=()=>o.Engine.createElement("div",{className:"feed-post-video-full-title"},this.state.title)}renderVideo(e){const{content:t}=this.props
return o.Engine.createElement("div",{ref:Object(f.as)(this,"post"),className:"feed-post bstn-item-shape type-"+this.props.type},o.Engine.createElement("div",{className:"feed-post-body",onClick:et},this.Header(t),this.Title(),o.Engine.createElement("div",{className:"feed-media-wrapper"},o.Engine.createElement(a.LabelEvent,{type:"click",label:"midia"},o.Engine.createElement("a",{href:e,className:"feed-post-figure-link gui-image-hover"},o.Engine.createElement(H,Qe({ref:Object(f.as)(this,"video")},t,{isEsppub:Boolean(Object(c.get)(this,"props.pubeditorial")),disableLightbox:ie(this.getPostContentData())}))))),this.Metadata(),this.Relateds()))}renderVideoFull(e){const{content:t}=this.props
return o.Engine.createElement("div",{ref:Object(f.as)(this,"post"),className:"feed-post bstn-item-shape type-"+this.props.type+" feed-post-video-full-container"},o.Engine.createElement("div",{className:"feed-post-body",onClick:et},o.Engine.createElement("div",{className:"feed-media-wrapper"},o.Engine.createElement(a.LabelEvent,{type:"click",label:"midia"},o.Engine.createElement("a",{href:e,className:"feed-post-figure-link gui-image-hover"},o.Engine.createElement(H,Qe({},t,{ratio:"4:3",extraClasses:"feed-post-video-full",isEsppub:Boolean(Object(c.get)(this,"props.pubeditorial")),isLive:this.isLive(),disableLightbox:ie(this.getPostContentData())}),this.renderHeader(),this.renderTitle(),this.Metadata())))),this.Relateds()))}render(){const e=this.props.content
e.url=e.url||Object(c.get)(e,"video.url")||$.Globals.location.href
const t=e.url||""
return j.At.smallScreen?this.renderVideoFull(t):this.renderVideo(t)}Header(e){return o.Engine.createElement(E.Header,{content:e},Object(S.insertIf)(this.isLive(),()=>tt))}titleApplyRef(e){if(!ie(this.getPostContentData()))return Object(_.applyVideoLightbox)(e)}Title(){if(Object(le.has)(this,"state.title")){const e=this.getUrl(),t=Object(c.get)(this.props.content,"video.id")
return o.Engine.createElement(d.Title,{text:this.state.title,innerWrapper:n=>o.Engine.createElement("h2",null,o.Engine.createElement("a",{href:e,className:"feed-post-link gui-color-primary gui-color-hover","data-video-id":t,"data-short-url":e,"data-link":e,ref:e=>this.titleApplyRef(e)},n.children))})}return null}componentWillMount(){this.reporter=Te.upgrade(this.context.sharedItemData,{isLive:this.isLive()}),this.reporter.addFeatureChecks({video:()=>!0})}isLive(){return Object(Xe.isLiveVideo)(Object(c.get)(this.props.content,"video.kind"))}}nt.FACE="video",n.d(t,"emitter",(function(){return rt})),n.d(t,"NEW_POST_TYPE",(function(){return it})),n.d(t,"registerExternalItemFactory",(function(){return ot})),n.d(t,"assignFactory",(function(){return at}))
const rt=new pe.EventEmitter,it="NEW_POST_TYPE_",st={default:ue,basico:ue,materia:ue,materia_video:ue,advertise:i.default,cobertura:je,stories:class extends ue{constructor(...e){super(...e),this.StoriesMobile=()=>o.Engine.createElement("div",{ref:Object(f.as)(this,"post"),className:"feed-post bstn-item-shape type-"+this.props.content.type+" stories",style:{borderBottom:"5px solid "+Object(Fe.getCategoryColor)()}},o.Engine.createElement("div",{className:"feed-media-wrapper"},o.Engine.createElement(a.LabelEvent,{type:"click",label:"midia"},o.Engine.createElement("a",{href:this.props.content.url,className:"feed-post-figure-link gui-image-hover"},o.Engine.createElement(Ye,Je({mobile:!0,extraClasses:"feed-post-stories-mobile",ref:Object(f.as)(this,"stories")},this.props.content),this.Metadata()))))),this.StoriesDesktop=()=>o.Engine.createElement("div",{ref:Object(f.as)(this,"post"),className:"feed-post bstn-item-shape type-"+this.props.content.type},o.Engine.createElement("div",{className:"feed-post-body"},this.Header(),this.Title(),o.Engine.createElement("div",{className:"feed-media-wrapper"},o.Engine.createElement(a.LabelEvent,{type:"click",label:"midia"},o.Engine.createElement("a",{href:this.props.content.url,className:"feed-post-figure-link gui-image-hover"},o.Engine.createElement(Ye,Je({desktop:!0,extraClasses:"feed-post-stories-desktop",ref:Object(f.as)(this,"stories")},this.props.content))))),this.Summary(),this.Metadata()))}render(){return j.At.smallScreen?this.StoriesMobile():this.StoriesDesktop()}},"especial-publicitario":de,video:nt,"eventos-esportivos":He},ot=(e,t)=>{((e,t)=>{"advertise"!==e&&"especial-publicitario"!==e&&(st[e]=t,rt.trigger(it+e))})(e,xe(t))},at=e=>{let t=e.type
return e.pubeditorial&&"cobertura"!==t&&(t="especial-publicitario"),!(t in st)&&(e=>Object(c.get)(e,"content.title")&&Object(c.get)(e,"content.url"))(e)&&(t="default"),t in st&&(e.klass=st[t]),e}},function(e,t,n){"use strict"
n.r(t)
var r=n(20),i=n(87),s=n(124),o=n.n(s),a=n(23),c=n(85),l=n(130),u=n(139),h=n(140),d=n(100),p=n(116),f=n.n(p),m=n(5),g=n.n(m),v=n(10),b=n.n(v),E=n(30),_=n.n(E),y=n(77),O=n.n(y),w=n(86),S=n(189),I=n(105),C=n(1),x=n.n(C),T=n(22),A=n(193)
let j
const N={}
...
i={next:e=>{t.push(e),t.length<10?n.request(o()):s()},error:t=>{Object(r.error)(t),s(),e.error(t)},complete:()=>{s(),e.complete()}},n.stream.addListener(i),this.isBusy=!0,n.request(o())}}flush(){g()(this.deliver)&&this.deliver()}}var q=n(54)
let W
const $=/(.*\/)([^?#]*)(\?[^#]*|)(#.*|)/
const K=/(?:(.*\/)([^/]+)\/feed\/pagina-(\d+)(\.g?html|\/|)|(.*\/)([^.]*)(\.g?html|))/,Z=/\..*/
function Y(){const e=a.Configs.get("referer")||"",t=function(e){const t=e.match($)||["","","",""],[,n,r,i,s]=t
return{path:n,name:r,querystring:i,hash:s}}(e),n=(""+t.path+t.name).match(K)||["","","","","",""],[,r,i,s,o,c,l,u]=n
return{path:c||r,name:l&&l.replace(Z,"")||i||"index",page:s||"1",extension:u||o||"",querystring:t.querystring,hash:t.hash,decomposed:Boolean(e&&(c||r))}}const J={getPageURL:function(e){return W=W||Y(),W.decomposed?""+W.path+W.name+"/feed/pagina-"+e+W.extension+W.querystring+W.hash:null},destroy:function(){W=null}}
var X=n(119),Q=n(133),ee=n(57)
var te=n(190)
...
return!!(e.isBoxed&&e.rect.bottom<e.viewportHeight+1e3)&&(this.handleLoadMore(),!0)}}var re=n(192),ie=n(141),se=n(186),oe=n(169),ae=n(25),ce=n(69),le=n(70),ue=n(198)
...
return n||r}resetItemIndex(){this.itemIndex.clear(),new Array(se.Headlines.getConsumed()).fill().forEach(()=>this.itemIndex.register(oe.ItemIndex.HEADLINE_PLACEHOLDER))}}var fe=n(89),me=n(92),ge=n(56),ve=n(122)
...
var x=a.Engine.createElement("div",{className:"text"},a.Engine.createElement(()=>C,null)," SIGA EM TEMPO REAL"),T=a.Engine.createElement(()=>I,null)
function A({spectators:e}){return a.Engine.createElement("div",{className:"label-tempo-real headline"},x,Object(S.insertIf)(e,()=>a.Engine.createElement("div",{className:"count"},T," ",e.toLocaleString("pt-br")," assistindo")))}var j=n(72),N=n(190),R=n(94)
class P extends R.BaseReporter{constructor(e){super(e),this.isLive=e.isLive,this.status=e.status}get contentStatus(){return this.status?this.status:this.isLive?"ao_vivo":void 0}get format(){return"destaque"}get size(){return u.POST_SIZES.LARGE}getPostPosition(){return this.data.index+1}}const k=Object(R.createPostReporter)(P)
var L=n(54),D=n(137),M=n(144),H=n(76),V=n(145),F=n(25),U=n(146),G=n(154),B=n.n(G),z=n(161),q=n(59),W=n(70),$=n(197),K=n(136)
...
return a.Engine.createElement("div",null,a.Engine.createElement(d.ElementViewTrigger,{on:"fitInScreen"},a.Engine.createElement("span",Z({className:"bstn-hl-title gui-color-primary gui-color-hover gui-color-primary-bg-after",ref:Object(O.as)(this,"title")},u),r)),Object(S.insertIf)(i||s,()=>h,()=>Object(S.insertIf)(c,()=>a.Engine.createElement("div",{className:"highlights-bastian-feed"},l.slice(0,2).map((e,t)=>a.Engine.createElement($.Highlight,{key:t,content:e,headline:!0})),Y))))}componentDidMount(){this.props.hasVideo&&Object(K.applyVideoLightbox)(this._refs.title)}}function X(){return(X=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]
for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e}).apply(this,arguments)}const Q=({allowThumb:e})=>(t,n)=>{const{title:r,url:i}=t.content,s=Object(F.get)(t.content,"image.sizes.S.url"),o={}
return e&&s&&(o.thumb={url:s,rightsholder:Object(F.get)(t.content,"image.rightsHolder")}),a.Engine.createElement("li",{key:n,className:"bstn-hl-itemlist bstn-hl-relateditem"},a.Engine.createElement(ee,X({title:r,url:i},o)))}
function ee({url:e,title:t,thumb:n}){const r=n&&n.url,i={}
return n&&n.rightsholder&&(i.alt=n.rightsholder,i.title=n.rightsholder),a.Engine.createElement("a",{className:"bstn-hl-link bstn-related",href:e},Object(S.insertIf)(r,()=>a.Engine.createElement("img",X({className:"bstn-hl-relatedthumb",src:r},i,{loading:"lazy"}))),a.Engine.createElement("span",{className:"bstn-hl-title gui-color-primary gui-color-hover bstn-related"},t))}var te=n(147),ne=n.n(te),re=n(9),ie=n.n(re),se=n(138),oe=n(135),ae=a.Engine.createElement(se.VideoPlay,null)
...
return a.Engine.createElement("div",{ref:Object(O.as)(this,"video"),className:"bstn-hl-video",title:e.title,"data-video-id":t,"data-short-url":e.url,"data-link":e.url,"data-title":e.title,"data-img":r},ae,Object(S.insertIf)(ie()(n),()=>a.Engine.createElement("div",{className:"bstn-hl-duration"},Object(oe.abbrTime)(n))))}return null}componentDidMount(){ne()(this._refs,"video")&&(Object(K.applyVideoLightbox)(this._refs.video),this._refs.video.addEventListener("click",e=>e.stopPropagation(),!1))}}var le=n(168),ue=a.Engine.createElement(le.default,{device:"desktop"})
...
return a.Engine.createElement("div",{className:"bstn-hl-wrapper"},a.Engine.createElement("div",{ref:Object(O.as)(this),style:{"--bstn-hl-cover":this.state.backgroundImage},className:l()("bstn-hl type-"+e.type,n),onClick:this.reportClick},a.Engine.createElement("a",{className:"bstn-hl-link",href:h},Object(S.insertIf)(t.hasLabelTempoReal,()=>a.Engine.createElement(A,{spectators:t.showSpectators?i:0})),a.Engine.createElement("ul",{className:"bstn-hl-list"},Object(S.insertIf)(t.hasChapeu||t.isLive,()=>a.Engine.createElement("li",{className:"bstn-hl-itemlist bstn-hl-chapeuitem"},Object(S.insertIf)(t.isLive,()=>fe,()=>Object(S.insertIf)(t.hasChapeu,()=>p)))),me,a.Engine.createElement("li",{className:"bstn-hl-itemlist bstn-hl-playbutton "},Object(S.insertIf)(t.hasVideo,()=>a.Engine.createElement(ce,this.props.content))),a.Engine.createElement("li",{className:"bstn-hl-itemlist bstn-hl-playbutton bstn-hl-video"},Object(S.insertIf)(t.isStories,()=>ge)),a.Engine.createElement("li",{className:"bstn-hl-itemlist bstn-hl-mainitem"},Object(S.insertIf)(c&&u,()=>a.Engine.createElement(_.Scoreboard,{headline:!0,away:c,home:u})),a.Engine.createElement(J,de({},e.content,t,{title:this.state.title,match:r}))),Object(S.insertIf)(!t.isUber,()=>s.map(Q({allowThumb:!1})))))),Object(S.insertIf)(t.isUber&&t.hasRelated,()=>a.Engine.createElement("ul",{className:"bstn-hl-uberrelateds",onClick:this.reportClick},s.map(Q({allowThumb:!0})))))}componentWillMount(){const e=this.getFeatures(),t=new k({data:this.props,telemetry:this,isLive:e.isLive,status:e.hasScore&&String(this.getProps().status).toLowerCase()})
...
Object(N.default)(t,["GA","CommonEvents"],{generateLabel:!0})}reportToRealtime(){const e=this.props
...
return a.Engine.createElement(d.ElementViewTrigger,{on:"partial",chain:"headlines",checkInterval:1e3},a.Engine.createElement("div",{className:l()("bstn-hls","xlarge-22","xlarge-offset-1","theme","model-"+e.length,{["variation-"+t]:t}),ref:we},a.Engine.createElement(h.ElementViewGroup,{id:"headlines",radius:2},e.map((n,r)=>a.Engine.createElement(ve,ye({index:r,key:r,isSingle:1===e.length&&0===r,isHalfSize:3===e.length&&r>=1,headlineVariation:t},n))))))}}const we=e=>{const t=/^((?!chrome|android).)*safari/i.test(navigator.userAgent)
...
t&&(n='url("'+t+'")')}return n},Ce=({items:e})=>a.Engine.createElement(d.ElementViewTrigger,{on:"partial",checkInterval:1e3},a.Engine.createElement("div",{className:"bstn-uhl xlarge-22 xlarge-offset-1 theme"},a.Engine.createElement(Te,e[0])))
var xe=a.Engine.createElement(D.BadgeAoVivo,null)
class Te extends y.SeenTimeTelemetry{constructor(e){super(e),this.handleClick=e=>{if(this.reportClick(),!e.defaultPrevented){const e=this._refs.node.querySelector(".bstn-uhl-picture .bstn-uhl-link")
...
let Re,Pe=0
const ke={}
class Le{static getInstance(){return Re||(Re=new Le(ke)),Re}static getConsumed(){return Pe}constructor(e){if(e!==ke&&Object(r.warn)("Class Headlines is a singleton and shouldn't be called directly."),this.items=De(),this.items.length>0){const e="uber"===o.Configs.get("headlineVariation")&&i.At.screen(i.SMALL_SCREEN)?Ce:Oe
...
n.r(t)
var r=n(16),i=n.n(r),s=n(107),o=n.n(s),a=n(89),c=n(20),l=n(55),u=n(56),h=n(54),d=n(69),p=n(193),f=n(87),m=n(28),g=n(71),v=n(25),b=n(179),E=n(70),_=n(180),y=n(195),O=n(185),w=n(186),S=n(105),I=n(85),C=n(141),x=n(130),T=n(139),A=n(198),j=n(169),N=n(140),R=n(100)
n(131)
let P
...
r&&U.PostIndex.loadInitialURLs(r),V.Configs.absorbConfigs(t),t.items=(({items:e})=>e.filter((e,t,n)=>t===n.findIndex(t=>B(t)===B(e))))(t),(e=>{if(V.Configs.get("isHomeOrTopic")){const t=Object(m.getFirstPostWithImageForLCP)(e)
...
if(S.$DistributedComponents.getInstance(t),n){V.Configs.set("recommendationTag",n.tag)
...
if(i)for(let t=0;t<i.length&&n>0;t++)e.items.splice(r,0,i[t]),r+=1,B(i[t])!==B(e.items[0])&&(n-=1)}},Y=(e,t)=>{Object(E.triggerDomEvent)(d.LAUNCH_FAILED,h.Globals.document,t=>{t.component=e})
...
if(i&&o()(s))try{s.innerHTML="",f.Engine.render(i,s)}catch(n){Y(r,n)}}})(n,t)),Object(_.setupVideoPreviewViewportObserver)(),(e=>{const t=ee(a.BANNER_SLB_MEIO),n=ee(a.SHOWTIME_INITIALIZED)
...
n.r(t)
var r=n(16),i=n.n(r),s=n(107),o=n.n(s),a=n(124),c=n.n(a),l=n(20),u=n(115),h=n(55),d=n(133),p=n(87),f=n(54),m=n(85),g=n(56),v=n(100),b=n(1),E=n.n(b),_=n(6),y=n.n(_),O=n(170),w=n.n(O)
...
var f=n(1),m=n.n(f),g=n(73),v=n(74),b=n.n(v),E=n(10),_=n.n(E),y=n(75),O=n(56),w=n(23)
let S,I=null
...
if(n.innerHTML=Object(a.default)(l.Engine.createElement(e,t)),i()(n.firstChild))return n.removeChild(n.firstChild)}n.d(t,"Relateds",(function(){return C})),n.d(t,"Relacionados",(function(){return x})),n.d(t,"Cover",(function(){return T})),n.d(t,"Foto",(function(){return A})),n.d(t,"Datetime",(function(){return j})),n.d(t,"Datahora",(function(){return N})),n.d(t,"Header",(function(){return R})),n.d(t,"Chapeu",(function(){return P})),n.d(t,"Metadata",(function(){return k})),n.d(t,"Metadados",(function(){return L})),n.d(t,"Section",(function(){return D})),n.d(t,"Secao",(function(){return M})),n.d(t,"Summary",(function(){return H})),n.d(t,"Sumario",(function(){return V})),n.d(t,"Title",(function(){return F})),n.d(t,"Titulo",(function(){return U})),n.d(t,"Video",(function(){return G})),n.d(t,"PlayIcon",(function(){return B})),n.d(t,"IconePlay",(function(){return z}))
...
if(t)return o()(e).forEach(e=>t.appendChild(e)),t},L=k,D=({text:e})=>I(b.Section,{text:e}),M=D,H=({text:e})=>I(E.Summary,{text:e}),V=H,F=({text:e})=>I(_.Title,{text:e}),U=F,G=e=>{const{alt:t,image:n,url:r}=e,i=e.video
...
n.r(t)
var r=n(5),i=n.n(r),s=n(69),o=n(76),a=n(192),c=n(188),l=n(130),u=n(87),h=n(72),d=n(190),p=n(90),f=n(142),m=n(140),g=n(100),v=n(145),b=n(25),E=n(57),_=n(59),y=n(101),O=n(70),w=n(110),S=n(55),I=n(20)
...
try{e=Object(w.default)(this.props.children),t="_evt"}catch(n){e=this.getFallbackElement(),t="bstn-error-boundary",Object(I.error)("ErrorBoundary:",n)}return u.Engine.createElement("div",{className:t,dangerouslySetInnerHTML:{__html:e}})}getFallbackElement(){let e=this.props.fallback
...
let e
return S.At.client?e=this.props.children:S.At.server&&(e=this.getSSRElement()),e}}var x=n(184)
